...
// Enums
export const userRoleEnum = pgEnum("user_role", ["site_admin", "head_housekeeper", "room_attendant", "maintenance", "front_desk_manager"]);
...
export const roomStatusEnum = pgEnum("room_status", ["dirty", "clean", "out_of_order", "maintenance"]);
